...
// 800: "hsl(235, 100%, 33%)";
// 900: "hsl(235, 100%, 22%)";
/* color: hsl(235, 100%, 58%);
color: hsl(235, 100%, 88%);
color: hsl(235, 100%, 86%);
color: hsl(235, 100%, 81%);
color: hsl(235, 100%, 76%);
color: hsl(235, 100%, 71%);
color: hsl(235, 100%, 66%);
color: hsl(235, 100%, 58%);
color: hsl(235, 100%, 44%);
color: hsl(235, 100%, 33%);
color: hsl(235, 100%, 22%); */
